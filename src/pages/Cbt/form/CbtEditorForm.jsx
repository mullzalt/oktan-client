...
const CbtEditorForm = props => {

    const { data, onSave, isLoading, onCancel, buttonText, displayCancel } = props
...
CbtEditorForm.defaultProps = {
    buttonText: 'save',
    displayCancel: true
}

export default CbtEditorForm